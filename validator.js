...
(function() {
  ...
  $.extend(Validator.messages, {
    defaults: function(elem) {
      ...
      return msg != null ? msg : msg = 'Wrong';
    },
    required: function(elem) {
      var msg;
      msg = elem.attr('data-msg');
      return msg != null ? msg : msg = 'Mandatory';
    },
    min: function(elem) {
      var min, msg;
      min = elem.attr('min');
      msg = elem.attr('data-msg');
      return msg != null ? msg : msg = "It may not be less then " + min + " characters";
    },
    max: function(elem) {
      var max, msg;
      max = elem.attr('max');
      msg = elem.attr('data-msg');
      return msg != null ? msg : msg = "It may not be more then " + min + " characters";
    },
    regexp: function(elem) {
      var msg;
      msg = elem.attr('data-msg');
      return msg != null ? msg : msg = 'Wrong format';
    }
  });
